...
def TextMeWhenDone(phone_carrier, phone_10digits, gmail_address,
                   gmail_APP_password, process, **process_args_dict):
    """
    ...
    **process_args_dict: dictionary
    ...
    carrier_suffixes = {'AT&T': 'txt.att.net', 'T-Mobile': 'tmomail.net',
    ...
    FROM = gmail_address
    TO = [FROM, "{0}@{1}".format(phone_10digits, domain)]
...
if __name__ == '__main__':
    ...
    # Make up some function to simulate another function that takes a long time
    # to run
    ...
    TextMeWhenDone('AT&T', '415-------', '...@gmail.com', '16letters',
                   VeryLongProcess, **kwargs)
